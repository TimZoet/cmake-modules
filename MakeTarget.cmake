...
function(make_target)
	...
	if(EXAMPLE)
		# Return if examples are globally disabled.
    ...
    if(TYPE STREQUAL "test")
		# Return if tests are globally disabled.
		if(NOT BUILD_TESTS)
			return()
		endif()
		# Add option for this specific target.
		option(BUILD_${NAME} "Build this test target" ON)
		if(NOT BUILD_${NAME})
			return()
		endif()
	endif()
	...
	set_target_properties(${NAME} PROPERTIES
		ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/lib/${OUTDIR}$<0:>"
		LIBRARY_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/lib/${OUTDIR}$<0:>"
		RUNTIME_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/bin/${OUTDIR}$<0:>"
	)
